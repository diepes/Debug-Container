...
def search_and_replace(file_in, file_out):
    ...
    pattern_name = r'"resource_id":.+(/virtualMachines/|/networkInterfaces/|/resourceGroups/|/Microsoft.Sql/servers/)(?P<Name>[^"/]+)",'  # Regex pattern to capture virtual machine name
    ...
    pattern_ext = r'"resource_id":.+(/virtualMachines/|/Microsoft.Sql/servers/)(?P<Name>[^"/]+)(/extensions/|/firewallRules/)(?P<Ext>[^"]+)",'  # Regex pattern to capture virtual machine name
    new_lines = []
